...
<script>
    function showPass(){
        ...
        textPassword.type = (password === "password") ? "text" : "password";
        let eyeIcon = document.getElementById("eye-icon");
        eyeIcon.className = (password === "password") ? "bi bi-eye-slash" : "bi bi-eye";
    }
    ...
    const handleSignIn = (event) => {
        ...
        if(email === ""){
            ...
            if(email === "222310018@student.ibik.ac.id" && password === "222310018"){
